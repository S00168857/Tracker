...
const sequelize = new Sequelize('GPSTracker', 'Administrator', 'MSPress*1', { //*database*username*password
    host: 'projectinstance.cjhbu2jhd3qt.eu-west-1.rds.amazonaws.com',//URL to db
